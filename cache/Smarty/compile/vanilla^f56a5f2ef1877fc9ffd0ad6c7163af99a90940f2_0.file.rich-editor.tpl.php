<?php
/* Smarty version 3.1.33, created on 2019-05-15 02:46:38
  from 'D:\BobydoInc\Website\VanillaForums\plugins\rich-editor\views\rich-editor.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5cdb7d8ed166f1_27521578',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f56a5f2ef1877fc9ffd0ad6c7163af99a90940f2' => 
    array (
      0 => 'D:\\BobydoInc\\Website\\VanillaForums\\plugins\\rich-editor\\views\\rich-editor.tpl',
      1 => 1556064456,
      2 => 'file',
    ),
  ),
...
function content_5cdb7d8ed166f1_27521578 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'D:\\BobydoInc\\Website\\VanillaForums\\library\\SmartyPlugins\\function.t.php','function'=>'smarty_function_t',),));
?>
...
" class="sr-only">
    ...
    <div class="richEditor-frame InputBox">
        ...
        <div class="richEditor-embedBar">
            <ul class="richEditor-menuItems" role="menubar" aria-label="<?php echo smarty_function_t(array('c'=>"Inline Level Formatting Menu"),$_smarty_tpl);?>
">
                <li class="richEditor-menuItem u-richEditorHiddenOnMobile" role="menuitem">
                    <button class="richEditor-button richEditor-embedButton" type="button" aria-pressed="false" disabled="disabled">
                        <svg class="richEditorButton-icon" viewBox="0 0 24 24">
                            <title><?php echo smarty_function_t(array('c'=>"Emoji"),$_smarty_tpl);?>
</title>
                ...
                <?php if ($_smarty_tpl->tpl_vars['editorData']->value['hasUploadPermission']) {?>
                <li class="richEditor-menuItem" role="menuitem">
                    <button class="richEditor-button richEditor-embedButton richEditor-buttonUpload" type="button" aria-pressed="false" disabled="disabled">
                        <svg class="richEditorButton-icon" viewBox="0 0 24 24">
                            <title><?php echo smarty_function_t(array('c'=>"Image"),$_smarty_tpl);?>
</title>
                ...
                <li class="richEditor-menuItem" role="menuitem">
                    <button class="richEditor-button richEditor-embedButton" type="button" aria-pressed="false" disabled="disabled">
                        <svg class="richEditorButton-icon" viewBox="0 0 24 24">
                            <title><?php echo smarty_function_t(array('c'=>"Embed"),$_smarty_tpl);?>
</title>
